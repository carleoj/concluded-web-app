...
export default function Hero({ onStartAnalyzing }: HeroProps) {
  return (
    <section
      className="
    px-4 pb-8 pt-10
    sm:px-6 sm:pb-11 sm:pt-27
    bg-[linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url('/bg-corp.jpg')]
    bg-cover bg-center
  "
    >
      <div
    ...
    px-6 py-16 sm:px-10 sm:py-24 lg:px-16
    before:absolute before:inset-0
    before:bg-[url('/bg-corp.jpg')]
  ...
  "
      >
        <span
          aria-hidden="true"
          className="hero-mark pointer-events-none absolute -right-4 -top-16 select-none text-[15rem] font-semibold leading-none tracking-[-0.12em] text-accent/10 sm:text-[22rem]"
        >
          C
        </span>
        ...
        <div className="relative z-10">
          ...
          <button
            ...
            className="mt-9 rounded-full bg-accent px-7 py-3.5 text-sm font-semibold text-primary transition-transform duration-200 hover:-translate-y-0.5 hover:cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
          >
            Start analyzing
          </button>
        </div>
